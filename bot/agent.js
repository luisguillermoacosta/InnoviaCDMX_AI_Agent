...
- **Rango típico de inversión:** $${(pricing.rango_tipico_min || 35000).toLocaleString()} – $${(pricing.rango_tipico_max || 39000).toLocaleString()} MXN
- **Con promociones de asesora en cita, desde:** $${(pricing.techo_promocion || 30000).toLocaleString()} MXN
